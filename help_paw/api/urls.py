...
from info.views import (MyShelterNewsViewSet, MyShelterVacancyViewSet,
                        NewsViewSet, ShelterNewsViewSet, VacancyViewSet)
...
v1_router.register(r'shelters/(?P<shelter_id>\d+)/vacancies', VacancyViewSet, basename='shelter_vacancies')
v1_router.register(r'my-shelter/vacancies', MyShelterVacancyViewSet, basename='my_shelter_vacancies')
